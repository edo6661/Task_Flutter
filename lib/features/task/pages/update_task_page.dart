  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: MainText(text: "Update New Todo", extent: Large()),
      ),
  ...
  onUpdateTask() async {
    if (formKey.currentState!.validate()) {
      ...
      await context.read<TasksCubit>().updateTask(
            ...
            // ! is sync 0 dulu aja karena takutnya user gak punya internet, jadi nanti auto di sync kalo udah ada internet
            isSynced: 0,
          ));
    }
  }
